...
const Card = ({key,src,alt,name,address,city,phone}) => {
  return (
    <div key={key} className='w-[320px] h-[250px] rounded-[8px]  overflow-hidden  shadow-[4px_4px_12px_rgba(0,0,0,0.25)] hover:scale-105 '>
